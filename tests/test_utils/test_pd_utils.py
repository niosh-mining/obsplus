...
class TestInt64toIntObj:
    """tests for converting int64 columns to int/object columns."""
    ...
    def int_df(self):
        ...
        df["col1"] = [1, 2, None]
        df["col2"] = [1, 2, 3]
        return df.astype({"col1": pd.Int64Dtype(), "col2": pd.Int64Dtype()})

    def test_convert(self, int_df):
        """Ensure converting replaces nulls with Nones."""
        out = int64_to_int_obj(int_df)
