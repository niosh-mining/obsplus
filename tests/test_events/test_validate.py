...
class TestValidateCatalog:
    ...
    def test_s_before_p(self, cat1):
        """ ensure raise if there are any s picks are before p picks """
        cat = cat1.copy()
        # Moving a s time before p time on the same station
        # picks[3] is a known s pick
        # pick[2] is a knwon p pick
    ...
    def test_amp_times(self, cat1):
        ...
        tw = TimeWindow(begin=0,
                        end=0.5,
                        reference=pick.time + 10)
