...
release = obsplus.__version__

# General information about the project.
project = f"ObsPlus  [ {version} ]"
...
# [howto/manual]).
latex_documents = [
    ("index", "obsplus.tex", "obsplus Documentation", "Derrick Chambers", "manual")
]
...
man_pages = [("index", "obsplus", "obsplus Documentation", ["Derrick Chambers"], 1)]
